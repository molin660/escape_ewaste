...
#Class: ICSU1-04
#Decription: This is my final summative task which is creating a video game the objective of the game is to collect the most points. There are harmful e-wastes falling from the top of the screen which will damage the player upon contact however, at random, one of these T.Vs will generate more food when clicked on. The fish will be frozen for 5 seconds every so often so they player will not be able to (escape the e-waste) 
